const n=`# LLM Wiki — Agent 记忆系统工程化(Memory Engineering in Production)
...
- 用 compaction、结构化笔记、多 agent 架构隔离记忆读写\r
...
*本文档由 arXiv 一手论文(编号逐条核实)、官方文档与 GitHub 高星仓库综合而成。厂商自测分数需以第三方复测为准;待核实项均已明确标注。*\r
`;export{n as default};
